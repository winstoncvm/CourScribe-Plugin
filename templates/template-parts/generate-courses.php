<div id="generateCoursesOffcanvas" class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
    <div class="offcanvas-header mt-6">
        <h5 id="offcanvasRightLabel">Generate Courses</h5>
    ...
    <div class="offcanvas-body">
        <div id="courscribe-generate-courses-form">
            <div class="options">
                <div class="btns-add">
                    <div>
                    ...
                    <div>
                        <label for="module-count">Number of Courses</label>
            ...
            <div class="ai-input-container">
                ...
                <button class="ai-send-button" id="courscribe-generate-courses">
        ...
        <div id="courscribe-generated-courses" class="mt-4" style="display: none;">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h6>Generated Courses</h6>
                <button class="btn courscribe-stepper-nextBtn" id="courscribe-select-all-courses">Select All</button>
            </div>
            <div id="courscribe-courses-list">
                <!-- Generated courses will be dynamically added here -->
            </div>
            <div class="mt-3">
                <button class="add-objective" id="courscribe-add-selected-courses"><i class="fa fa-plus me-2 custom-icon" aria-hidden="true"></i> Add Selected Courses</button>
