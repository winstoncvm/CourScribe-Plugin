...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
                <div class="sidenav-header">
                    ...
                    <a class="navbar-brand m-0" href="#">
                        <img src="<?php echo site_url('/wp-content/uploads/2024/12/logo1.png', ); ?>" class="navbar-brand-img h-100" alt="main_logo">
                        <span class="ms-1 text-white font-weight-bold">CourScribe</span>
                    </a>
                </div>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link  " href="#">
                                ...
                                <span class="nav-link-text text-white ms-1">Studio</span>
                            </a>
                        </li>
